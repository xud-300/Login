...
from django.contrib.auth.forms import UserCreationForm, AuthenticationForm  # Импортируем встроенные формы для создания пользователей и аутентификации
from django.contrib.auth.models import User  # Импортируем модель User для работы с пользователями
from .models import Profile # Импортируем наши модели Profile
...
from django.contrib.auth.forms import AuthenticationForm  # Импортируем форму аутентификации из Django
from captcha.fields import ReCaptchaField  # Импортируем поле ReCaptcha для использования капчи
